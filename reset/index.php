...
<body>
    ...
    <!-- Login script -->
    <?php include('../controllers/send_link.php'); ?>
...
<?php echo $accountNotFoundErr;?>
<?php echo $accountFoundSucc; ?>
                ...
                bg-white border-2 border-gray-300 placeholder-gray-600 shadow-md focus:placeholder-gray-500 focus:bg-white focus:border-gray-600 focus:outline-none">
                            ...
                            <button type="submit" name="submit_email"	  class="mt-3 text-lg font-semibold
