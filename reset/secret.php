  ...
  <div class="max-w-sm mx-auto px-6">
        <div class="relative flex flex-wrap">
            <div class="w-full relative">
                <div class="md:mt-6">
				    <?php $errorpass ='<div class="text-center font-semibold text-black">
															...
															if($_GET['key'] && $_GET['reset'])
{
  ...
  $sql = $pdo->prepare("SELECT COUNT(id) FROM users WHERE md5(email) = :email AND md5(password) = :pass");
  $sql->bindValue(":email", $email);
  $sql->bindValue(":pass", $pass);
  $sql->execute();
															  if($sql->fetchColumn() == 1)
  {
	    $enterpass ='<div class="text-center font-semibold text-black">
							Please enter your new password</div>';
							$errorpass = "";
    ?>
	<?php echo $enterpass; ?>
									<?php echo $errorpass; ?>
                    <form class="mt-8" method="post" action="submit_new.php">
                ...
                bg-white border-2 border-gray-300 placeholder-gray-600 shadow-md focus:placeholder-gray-500 focus:bg-white focus:border-gray-600 focus:outline-none">
                            ...
                            <button type="submit" name="submit_password" class="mt-3 text-lg font-semibold
            ...
            px-6 py-3 block shadow-xl hover:text-white hover:bg-black">
                    ...
                    <div class="text-sm font-semibold block py-6 flex justify-center">
                        <a href="../login/"
                           class="text-black font-normal">Know your password? 
