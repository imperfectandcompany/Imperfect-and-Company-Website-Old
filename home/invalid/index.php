...
$error = $_GET['error'];
	...
	//undefined application
		case 1:
		$etitle = "Undefined Application";
		$emessage = "There was no application selected.";
		$eback = "../apply";
		break;
	//invalid application
		case 2:
		$etitle = "Invalid Application";
		$emessage = "Application does not exist.";	
		$eback = "../apply";		
		break;
	}
}
		...
		$etitle = "Error";
		$emessage = "There was an issue. Please try again.";
		$eback = "../";
}
?>
<!doctype html>
<html lang="en">
    <head>
        <title><?php echo $etitle; ?> - Imperfect and Company</title>
		<!-- CSS -->
...
<div class="w-full h-screen">
        ...
        <section class="bg-white py-10">
            <div class="max-w-5xl px-6 mx-auto text-center">
                <h2 class="text-2xl font-semibold text-gray-800">Uh oh</h2>

                <div class="flex flex-col items-center justify-center mt-6">
                    <div class="max-w-2xl w-full block bg-white shadow-md rounded-md border-t-4 border-red-600 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
                        <div class="flex items-center px-4 py-2">
                            <h3 class="text-lg font-medium text-gray-700 text-center"><?php echo $emessage; ?></h3>
                        </div>
                    </a>
            </div>
			
			                <div class="flex items-center justify-center mt-12">
                    <a class="flex items-center text-gray-600 hover:underline hover:text-gray-500" href="<?php echo $eback; ?>">
                        <span>Go back</span>
